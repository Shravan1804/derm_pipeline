...
DOCKER_ARGS := -v $(HOME):/workspace/ -v $(LOCAL_DATA_DIR):/data/ -v $$PWD/numba_cache_dir:/numba_cache_dir/ -v $$PWD/mpl_cache_dir:/mpl_cache_dir/ $(WANDB_CACHE_DIRS)  -p $(PORT):$(PORT) --rm --shm-size=4G
